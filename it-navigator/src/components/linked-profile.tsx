      ...
      <Card className="w-3/4">
        ...
        <CardContent>
          ...
          <section>
            ...
            <p className=" mb-2">Zamiast domyślnego “Software Developer w XYZ”, napisz coś takiego:</p>
            <ul className="list-disc list-inside space-y-1">
              <li>Backend Developer | Python & Django | Tworzę skalowalne API</li>
              <li>Frontend Developer | React, TypeScript | Perfekcyjny UI/UX</li>
            </ul>
            <p className=" mt-2">Dodaj swoje najmocniejsze strony + główne technologie.</p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold mb-2">📝 3. Sekcja „O mnie”</h2>
            <p className=" mb-2">Kilka zdań o Tobie. Idealna struktura: Kim jesteś, czym się zajmujesz, co Cię ekscytuje, jakie masz cele.</p>
          ...
          <section>
            ...
            <p className=" mb-2">Dodaj konkretne technologie:</p>
            <ul className="list-disc list-inside space-y-1">
              <li>Python</li>
              <li>Django</li>
              <li>React</li>
            ...
            <p className=" mt-2">Wskazówka: Uporządkuj je według ważności.</p>
          </section>
